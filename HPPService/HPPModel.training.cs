    ...
    public partial class HPPModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"MSZoning", @"MSZoning"),new InputOutputColumnPair(@"LotConfig", @"LotConfig"),new InputOutputColumnPair(@"BldgType", @"BldgType")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTreeTweedie(new FastTreeTweedieTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=17,NumberOfTrees=13,MaximumBinCountPerFeature=201,FeatureFraction=0.819445720076662,LearningRate=0.2833741279883,LabelColumnName=@"SalePrice",FeatureColumnName=@"Features"}));
