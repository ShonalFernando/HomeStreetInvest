...
namespace HomeStreetInvest_StockIntel
{
    public partial class GOOGL
    {
        ...
        private static string MLNetModelPath = Path.GetFullPath(@"D:\Source\Repos\HomeStreetInvest\HomeStreetInvest.StockIntel\GOOGL.zip");
