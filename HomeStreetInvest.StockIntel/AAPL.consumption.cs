...
namespace HomeStreetInvest_StockIntel
{
    public partial class AAPL
    {
        ...
        private static string MLNetModelPath = Path.GetFullPath(@"D:\Source\Repos\HomeStreetInvest\HomeStreetInvest.StockIntel\AAPL.zip");
