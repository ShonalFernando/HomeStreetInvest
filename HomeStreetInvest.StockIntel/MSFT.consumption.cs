...
namespace HomeStreetInvest_StockIntel
{
    public partial class MSFT
    {
        ...
        private static string MLNetModelPath = Path.GetFullPath(@"D:\Source\Repos\HomeStreetInvest\HomeStreetInvest.StockIntel\MSFT.zip");
