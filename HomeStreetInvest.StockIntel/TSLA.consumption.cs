...
namespace HomeStreetInvest_StockIntel
{
    public partial class TSLA
    {
        ...
        private static string MLNetModelPath = Path.GetFullPath(@"D:\Source\Repos\HomeStreetInvest\HomeStreetInvest.StockIntel\TSLA.zip");
